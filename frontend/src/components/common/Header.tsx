        ...
        <div style={{
            ...
            <div className="w-full max-w-custom mx-auto flex items-center justify-between">
                ...
                <div className="hidden lg:flex flex-1 justify-center items-center gap-12">
                    <Link href={'/jobs'} className='text-base text-dark font-normal'>About</Link>
                    <Link href={'/about'} className='text-base text-dark font-normal'>Services</Link>
                    <Link href={'/companies'} className='text-base text-dark font-normal'>Contact</Link>
